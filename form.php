...
<body>
<?php
include './theme_form/menu.php';
include './theme_form/logo.php';
?>
...
<div id="wrapper"> 
	...
	<div id="page">
		...
		<div id="content">
                    <div class="post">
				<h2 class="title"><a href="#">Anshita's gallery </a></h2>
		...
		<!-- end #content -->
		<?php
                include './theme_form/sidebar.php';
                ?>
		<!-- end #sidebar -->
		<div style="clear: both;">&nbsp;</div>
	</div>
...
if ($_POST) {
	...
	$q = mysqli_query($connection_1,
		...
		or die("Error". mysqli_error($connection_1));
